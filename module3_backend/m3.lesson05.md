...
For dealing with complex data - we'll need to aggrigate stages.
...
* Count how many matchedays ended had a game with result of 2:2
...
---
### NoSql data-modeling
What if all matches would be in a single array? can we do it without lossing data?
```
{
    "matchday": 1,
    "date": "2016-08-15",
...
* Insert the data from the [Document References example](https://docs.mongodb.com/manual/tutorial/model-referenced-one-to-many-relationships-between-documents/)
...
* do the same for football clubs data
...
---
### CRUD practice
* Replace static data with data from DB (make sure you use the right schema)
* implement CRUD for clubs collections
* deletion will remove all matches from rounds collection
* update will change all data in round collection
