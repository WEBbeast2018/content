...
A general rule would be - Do not make it top priority, but don't leave it out either.
...
<img src="./assets/illusion.jpg"  height="240" style="display:block; margin:10px auto; ">
...
* <!-- .element: class="fragment" -->Floating Point Calculations
...
* <!-- .element: class="fragment" -->Websocket vs Server.Push
...
### Caching Techniques
* [Server read/update Caching](https://www.youtube.com/watch?v=QcHKMp-yb9c)
...
---
### Caching - Demo and Practice
* [Knesset-backend](https://github.com/WEBbeast2018/knesset-data-backend)
* Suggest caching mechanism for [Knesset-frontend](https://github.com/WEBbeast2018/knesset-data-web-ui)
...
### Final words
* A word about memory
* [Javascript Memory leaks](https://www.youtube.com/watch?v=yAAEHi9kozE)
...
### Further reading
* [A must course for web-dev](https://www.udacity.com/course/browser-rendering-optimization--ud860)
* [http://webiks.com/idling-around-with-cesium-renderer-part-1/](http://webiks.com/idling-around-with-cesium-renderer-part-1/)
